...
from ANN import ConvNetBin2C1P2FC

def ClasDigito0(request):
    return render(request, "Demo60/ClasDigito0.html")

@xframe_options_exempt
def ClasificarDigito0(request):
    ...
    archivo = r"C:\Data\Python\2025_06_DADLCV\Demos\AppTorch\0.pt"
