...
class Dialogo(QDialog):
        ...
        if(data is not None):
            if(data!=""):
                ...
                for i in range(len(categorias)):
                    ...
                    grafico.ellipse([posX, alto - (valor + 70), posX + 50, alto - (valor + 20)], fill="yellow", outline=None, width=1)
                    grafico.text((posX + 5, alto - (valor + 60)), str(stocks[i]), font = fuente, fill = "red")                    
                    posX += 70
    ...
    def grabarGrafico(self):
        self.img.save("Grafico_Stock_Burbujas.png")
