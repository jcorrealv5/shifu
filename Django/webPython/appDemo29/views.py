...
def Consulta(request):    
    return render(request, "appDemo29/Consulta.html", {"Ver": "1.0001"})   
...
def ConsultarProductos(request):
    ...
    if(id==""):
        url = "http://190.43.83.241:8000/servicio01/ListarProductos"
    else:
        url = "http://190.43.83.241:8000/servicio01/ConsultarProducto?id=" + id
    try:
