...
function graficar(){
	...
	for(var i=3;i<nRegistros;i++){
		...
		if(posY<valor){
			...
			var grad=ctx.createLinearGradient(0,0, anchoColumna,alto - 50 - posY);
			grad.addColorStop(0, "aqua");
			grad.addColorStop(1, "blue");
			dibujarBarra3D(x, alto - 50 - posY, anchoColumna, posY, 2, "yellow", grad, 5);
			dibujarTexto(campos[1], x + 10, alto - 70 - posY, "white", "15px Arial");						
		}
		else{
			dibujarTexto(campos[0], x, alto - 30, "white", "15px Arial");
