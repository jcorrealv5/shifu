...
def Consulta(request):    
    return render(request, "appDemo31/Consulta.html", {"Ver": "1.0001"})   
...
def ConsultarProductos(request):
    ...
    if(id==""):
        url = "http://190.43.83.241:8000/servicio03/ListarProductos"
    else:
        url = "http://190.43.83.241:8000/servicio03/ConsultarProducto?id=" + id
    try:
