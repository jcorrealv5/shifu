...
print("1. Crear el DataSet de CIFAR100")
dsTrain = datasets.CIFAR100(root="datasets",train=True,download=True,transform=ToTensor())
print("DataSet Train: ", dsTrain)

batchSize = 32
print("2. Crear el DataLoader para manejar el DataSet CIFAR-100")
...
modelo = ConvNet6C3P3FC(100).to(device)
...
torch.save(modelo.state_dict(), 'CIFAR100.pt')
