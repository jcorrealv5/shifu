...
print("Demo 48: Convolucion de una Imagen con Kernel Especifico")
...
conv = Conv2d(in_channels=1, out_channels=1, kernel_size=3, bias=True)
...
Grafico.MostrarImagenes(imagenEntrada, imagenSalidaArray, "Kernel Laplaciano")